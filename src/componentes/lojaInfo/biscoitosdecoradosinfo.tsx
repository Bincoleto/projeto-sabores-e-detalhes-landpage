                ...
                <div className="container-biscoito-desc">
                    <div className="item-horizontal">
                        <div className="div-imagem">
                            <img src="public/img-biscodecorados/biscoito individual.jpg" alt="" />
                        </div>

                        <div className="div-descricao">
                            <h4>Biscoitos Individuais</h4>
                            <p>Deliciosos biscoitos amanteigados, decorados à mão 
                            com glacê real, perfeitos para lembrancinhas ou para 
                            adoçar seu dia com charme e sabor.</p>
                    ...
                    <div className="item-horizontal">
                        <div className="div-imagem">
                            <img src="public/img-biscodecorados/biscoito no palito.jpg" alt="" />
                        </div>

                        <div className="">
                            <h4>Biscoitos no Palito</h4>
                            <p>Um mimo criativo e encantador! Nossos biscoitos 
                            no palito unem sabor e beleza, ideais para compor 
                            mesas temáticas, lembrancinhas e presentear de forma especial.</p>
                    ...
                    <div className="item-horizontal">
                        <div className="div-imagem">
                            <img src="public/img-biscodecorados/biscoito 2d.jpg" alt="" />
                        </div>

                        <div className="">
                            <h4>Biscoitos 2D</h4>
                            <p>Arte em forma de doce! Biscoitos decorados em 2D, 
                            feitos com detalhes exclusivos em glacê real, trazendo 
                            um toque único e sofisticado para qualquer ocasião.</p>
